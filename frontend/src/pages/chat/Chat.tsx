...
import Contoso from "../../assets/brandonTunes.png";
                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Brandon's Tunes Chat</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>This chatbot uses my private mp3 collection and associated metadata; Ask me anything about my music.</h2>
                            </Stack>
                        ) : (
